    ...
    if(r.status_code != 200):
        ...
        while valid_answer == False:
            ...
            try:
                ...
                if(use_answer > len(answers) or user_answer <= 0):
        ...
        if user_answer == correct_answer:
            print("\n Congratulations! you answered correctly"+html.unescape(correct_answer))
            score_correct += 1
        else:
        ...
        print("\nYour score is: "+str(score_incorrect))
        print("\n#########################")
        
        endGame = input("\n Press enter to play again or type quit to exit").lower()
